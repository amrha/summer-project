...
def signup():
	...
	if form.validate_on_submit():
		if ((form.photo.data).filename[-4:]!=".png") and ((form.photo.data).filename[-4:]!=".jpg") and ((form.photo.data).filename[-5:]!=".JPEG"):
			return '<h1>we only accept images with png and jpg extentions you gave us '+(form.photo.data).filename[-4:]+'</h1>'
